...
if __name__ == "__main__":
  ...
  if N == "11111111111101": #1
  ...
  elif N == "11011111011000" or N == "11011111111000": #22
    mult = "A - B - C - D + F + G + H - K"
  elif N == "11011110011100": #23
    mult = "A - B - C - D + F + G + H + I"
  elif N == "11011010011100": #24
    mult = "A - B - C - D + G + H + I - L"
  elif N == "10011010111101" or N == "10011110111101": #25
    mult = "A - C - D + G + I - L - O + Q"
  elif N == "11011110011000" or N == "11011110111000": #26
    mult = "A - B - C - D + F + G + H"
    ...
    mult = "A - B - C - D + F + H"
  elif N == "11011010011000" or N == "11011010111000": #31
    mult = "A - B - C - D + G + H"
  elif N == "10011010111100" or N == "10011110111100": #32
    mult = "A - C - D + G + I - L"
  elif N == "11011000011100": #33
    mult = "A - B - C - D + H + I"
  elif N == "11011000011000": #34
    mult = "A - B - C - D + H"
  elif N == "10011010011100" or N == "10011110011100": #35
    mult = "A - C - D + G + I"
  elif N == "11011100010000": #36
    mult = "A - B - C + F"
  elif N == "11010000011000": #37
    mult = "A - B - D + H"
  elif N == "10011010011000" or N == "10011110011000": #38
    mult = "A - C - D + G"
  elif N == "10011000011100" or N == "10011100011100": #39
    mult = "A - C - D + I"
  elif N == "11011000010000": #40
    mult = "A - B - C"
  elif N == "10011000011000" or N == "10011100011000": #41
    mult = "A - C - D"
  elif N == "11010000010000": #42
    mult = "A - B"
  elif N == "10011000010000" or N == "10011010110000" or N == "10011100010000" or N == "10011000010000": #43
    mult = "A - C"
